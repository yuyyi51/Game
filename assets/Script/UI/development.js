...
cc.Class({
    ...
    update: function() {
        ...
        if (this.currentProject) {
            ...
            this.uiFraction.string = (Math.floor(this.currentProject.currentUi_*100)/100) + "/" + (Math.floor(this.currentProject.requireUi_*100)/100)
            this.funcFraction.string = (Math.floor(this.currentProject.currentFunc_*100)/100) + "/" + (Math.floor(this.currentProject.requireFunc_*100)/100)
        }
    }
